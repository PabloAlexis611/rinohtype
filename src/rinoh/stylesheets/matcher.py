...
matcher('toc level 4', TableOfContentsEntry.like(depth=4))
matcher('toc level 5', TableOfContentsEntry.like(depth=5))
matcher('toc level 6', TableOfContentsEntry.like(depth=6))
